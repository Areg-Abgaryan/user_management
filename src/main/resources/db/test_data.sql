INSERT INTO public.user_group (id, uuid, name) VALUES (1,'1eee76f6-e63b-46b9-9265-5597cd61aaba', 'AdminGroup');
INSERT INTO public.user_group (id, uuid, name) VALUES (2,'2eee76f6-e63b-46b9-9265-5597cd61aaba', 'UserGroup');
INSERT INTO public.user_group (id, uuid, name) VALUES (3,'3eee76f6-e63b-46b9-9265-5597cd61aaba', 'ReadOnlyGroup');


INSERT INTO public.user (id, creation_date, update_date, email, uuid, first_name, last_login, last_name, otp, otp_creation_time, password, salt, user_status, user_group_id) VALUES (8, '2024-03-09 02:33:07.625000', '2024-03-09 02:39:07.625000', 'user@gmail.com', '9c6237a8-a731-4f4a-a45d-b4c5b4291741', 'User', '2024-03-09 02:47:39.625000', 'Useryan', '12345', '1709937187', 'R5X6T6/cGTSqRS9jvj/x1LgLnacVRKU3qN/U4mqskmg=', 'xl3h&2bWF&23GxI2', 'ACTIVE', 2);
...
INSERT INTO public.object_group (id, uuid, name) VALUES (1, '1aee76f6-e63b-46b9-9265-5597cd61aaba', 'VMObjectGroup');
INSERT INTO public.object_group (id, uuid, name) VALUES (2, '2bee76f6-e63b-46b9-9265-5597cd61aabb', 'ClusterObjectGroup');
INSERT INTO public.object_group (id, uuid, name) VALUES (3, '3bee76f6-e63b-46b9-9265-5597cd61aabc', 'DCObjectGroup');
INSERT INTO public.object_group (id, uuid, name) VALUES (4, '4bee76f6-e63b-46b9-9265-5597cd61aabd', 'HostObjectGroup');
...
INSERT INTO public.object (entity_type, id, creation_date, update_date, uuid, name, domain_id, object_group_id) VALUES ('VM', 1, null, null, '1fff76f6-e63b-46b9-9265-5597cd61aaba', 'vmObj1', 1, 1);
INSERT INTO public.object (entity_type, id, creation_date, update_date, uuid, name, domain_id, object_group_id) VALUES ('VM', 2, null, null, '2eee76f6-e63b-46b9-9265-5597cd61aaba', 'vmObj2', 1, 1);
INSERT INTO public.object (entity_type, id, creation_date, update_date, uuid, name, domain_id, object_group_id) VALUES ('VM', 3, null, null, '3fff76f6-e63b-46b9-9265-5597cd61aaba', 'vmObj3', 1, 1);
INSERT INTO public.object (entity_type, id, creation_date, update_date, uuid, name, domain_id, object_group_id) VALUES ('VM', 4, null, null, '4eee76f6-e63b-46b9-9265-5597cd61aaba', 'vmObj4', 1, 1);
INSERT INTO public.object (entity_type, id, creation_date, update_date, uuid, name, domain_id, object_group_id) VALUES ('CL', 5, null, null, '5aee76f6-e63b-46b9-9265-5597cd61aaba', 'cluObj1', 2, 2);
INSERT INTO public.object (entity_type, id, creation_date, update_date, uuid, name, domain_id, object_group_id) VALUES ('CL', 6, null, null, '6bee76f6-e63b-46b9-9265-5597cd61aaba', 'cluObj2', 2, 2);
INSERT INTO public.object (entity_type, id, creation_date, update_date, uuid, name, domain_id, object_group_id) VALUES ('CL', 7, null, null, '7cee76f6-e63b-46b9-9265-5597cd61aaba', 'cluObj3', 2, 2);
INSERT INTO public.object (entity_type, id, creation_date, update_date, uuid, name, domain_id, object_group_id) VALUES ('DC', 8, null, null, '8bee76f6-e63b-46b9-9265-5597cd61aaba', 'dcObj1', 3, 3);
INSERT INTO public.object (entity_type, id, creation_date, update_date, uuid, name, domain_id, object_group_id) VALUES ('DC', 9, null, null, '9cee76f6-e63b-46b9-9265-5597cd61aaba', 'dcObj2', 3, 3);
INSERT INTO public.object (entity_type, id, creation_date, update_date, uuid, name, domain_id, object_group_id) VALUES ('HOST', 10, null, null, '0cee76f6-e63b-46b9-9265-5597cd61aaba', 'hostObj1', 4, 4);
